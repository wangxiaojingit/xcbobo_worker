...
$(function(){
	...
	var lourl="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx301d36d30e628ebf&redirect_uri="+urlType1+"xcbb_web/wh5/playFace/index2.html&response_type=code&scope=snsapi_userinfo&state=1#wechat_redirect";
    ...
    var headimgurl= "";
    var device="";
    var isShare2=window.location.href.indexOf("isShare2");
    if(!code||isShare2>0){
    ...
    var nexturl=urlType1+'xcbb_web/wh5/playFace/index2.html';
  ...
  //获取jsapi签名信息接口http://www.xiuktv.com/xcbb_open/event/getJsapiSign?url=http://localhost:8081/xcbb_open/eventtj/pv
    ...
    function weixinCallback (appId,timestamp,nonceStr,signature) {
        ...
        var sharelink=urlType1+'xcbb_web/wh5/playFace/index2.html';
